...
module.exports = flow = function (temporaryFolder) {
    ...
    $.get = function (req, callback) {
        var chunkNumber = req.param('flowChunkNumber');
        var chunkSize = req.param('flowChunkSize');
        var totalSize = req.param('flowTotalSize');
                    ...
                    fs.exists(getChunkFilename(currentTestChunk, identifier), function (exists) {
                        if (exists) {
                            ...
                            if (currentTestChunk > numberOfChunks) {
                                $.write(identifier, fs.createWriteStream($.temporaryFolder + filename, {flags: 'a'}));
                                $.clean(identifier);
