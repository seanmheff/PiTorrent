...
DOWNLOAD_GET_UPLOADED = "d.get_up_total";
...
DOWNLOAD_GET_BASE_FILENAME = "d.get_base_filename";
DOWNLOAD_GET_TORRENT_FILE_LOCATION = "d.get_loaded_file";
DOWNLOAD_GET_NUMBER_FILES = "d.get_size_files";
...
MULTICALL_DETAILED_TORRENT_INFO = [
    SYSTEM_MULTICALL,
    DOWNLOAD_GET_BASE_FILENAME,
    DOWNLOAD_GET_DIRECTORY,
    DOWNLOAD_GET_TORRENT_FILE_LOCATION,
    DOWNLOAD_GET_NUMBER_FILES,
    DOWNLOAD_GET_TORRENT_SIZE,
    DOWNLOAD_GET_COMPLETE,
    DOWNLOAD_GET_DOWNLOADED,
    DOWNLOAD_GET_UPLOADED,
    DOWNLOAD_GET_UPLOAD_RATE,
    DOWNLOAD_GET_DOWNLOAD_RATE
];
